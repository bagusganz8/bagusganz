...
sendButDocument(from, `Y`, `${menu}`, fs.readFileSync('./denz.jpg'), {mimetype:Mimetype.pdf, thumbnail:fs.readFileSync('./woi.webp'), filename:`Enjoy the menu!`}, [{buttonId:`rules`,buttonText:{displayText:'Rules'},type:1},{buttonId:`sewabot`,buttonText:{displayText:'Price'},type:1}], {quoted:finv2, contextInfo: { mentionedJid: [dtod,otod,stod], forwardingScore: 508, isForwarded: true, externalAdReply:{title:`${tampilUcapan} ${pushname}`,body:`${jmn} - ${week} - ${calender}`,mediaType:"2",thumbnail:ofrply,mediaUrl:`https://youtu.be/uQiF1yOnzDg`}}})
}
